(ns pz-discover.core
  ...
  (:require [com.stuartsierra.component :as c]
            ...
            [pz-discover.components :as components]))

(defn init [options]
  (alter-var-root #'pz-discover.system/current-system (constantly (components/system options))))

(defn start []
  (alter-var-root #'pz-discover.system/current-system c/start))

(defn stop []
  (alter-var-root #'pz-discover.system/current-system #(when % (c/stop %) nil)))
